...
# Paths
SKELETON_FOLDER = './mediapipe_skeletons'
ANNOTATION_FILE = '../labels.csv'
CHECKPOINT_PATH = './bilstm_fc_mediapipe/epoch_last.pth'

# Model Hyperparameters
MAX_FRAMES = 300
NUM_KEYPOINTS = 33
NUM_COORDS = 4
INPUT_SIZE = NUM_KEYPOINTS * NUM_COORDS  # 33 * 4 = 132
HIDDEN_SIZE = 256
NUM_LAYERS = 2
...
def main():
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        for data, labels in tqdm(train_loader, desc=f"Epoch {epoch+1}/{NUM_EPOCHS} [Train]"):
            ...
            if -1 in labels: continue # Skip batches with file not found errors
