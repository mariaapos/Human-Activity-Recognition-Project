...
test_loader  = DataLoader(test_ds, batch_size=8, num_workers=5, pin_memory=True, collate_fn=pad_collate)
...
# Load checkpoint
checkpoint_path = "./mobilenet_mlp_checkpoints/ckpt_epoch_40.pth"
